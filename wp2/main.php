...
<?
    ...
    // print_r(empty(get_field('hero', $indexACF)));
    // echo '</pre>';

    // $data = var_dump(get_field('основа', $indexACF));
    // $data = get_acf_field_lang('hero', $current_lang_slug, $indexACF)[0];
              ...
              <div class="map__banner">
                ...
                <div class="map__address" data-da=".map__header,1023.98,1">
                  <div class="map__address-item">
                    ...
                    <a href="tel:<?=$langMainACF['phone']['link'];?>" class="map__address-phone"><?=$langMainACF['phone']['title'];?></a>
                  </div>
      ...
      <div class="container">
        <div class="seo">
          ...
          <button class="seo__active button">
            <p class="footer__about-text">Читать полностью</p>
          </button>
        </div>
      </div>
    </section>
