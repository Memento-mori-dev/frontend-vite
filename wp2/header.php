...
<head>
    ...
    <title>Drum Family – Барабанная школа в <?=$langMainACF['sity-sub'];?> | Обучение игре на барабанах для детей и взрослых</title>
    ...
    <script src="https://api-maps.yandex.ru/2.1/?apikey=754aeff1-995c-4e19-ba04-b37768117b01&lang=ru_RU" type="text/javascript"></script>
    <script>
        ymaps.ready(init);
        function init() {
            let iconImageSize;
            ...
            if (screenWidth < 768) {
                ...
                iconImageOffset = [-50, -57]; 
            }else{
                iconImageSize = [196, 256];
                iconImageOffset = [-98, -128]; 
            }
    ...
    <style>
        ...
        width: 600px;
        height: 400px;
        /* filter: grayscale(100%); Черно-белая тема */
        }
    ...
    <header class="header opacity-top">
            <div class="header__container container">
                ...
                <p class="header__text">
                    ...
                    детей и взрослых <?=$langMainACF['sity-sub'];?>
                </p>
                </div>
                ...
                <ul class="list-address" data-da=".header__menu-address,1023.98,1">
                    <li>
                        ...
                        <div class="header__city">
                            <button class="header__city-title" data-js-modal-open="2"><?=$langMainACF['sity-logo'];?>
                            <span>
                    ...
                    <li>
                        ...
                        <p class="list-address__text"><?=$langMainACF['address'];?></p>
                    </li>
                </ul>
                </div>
